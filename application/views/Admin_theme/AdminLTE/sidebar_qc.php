...
<ul class="sidebar-menu">
    ...
    <li class="treeview">
        <?php echo anchor('supply_info', '<i class="fa fa-plus-circle"></i>  <span>Insert Info</span>'); ?>
    </li>
    <li class="treeview">
        <?php echo anchor('supply_style_no', '<i class="fa fa-slideshare"></i>  <span>Style No</span>'); ?>
    </li>
    <li class="treeview">
