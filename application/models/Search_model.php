...
class Search_model extends CI_Model {
    ...
    function getregister($id_supply_info) {
        $this->db->select('supply_fit_register.id_supply_fit_name,supply_fit_register_date_send as date_send,supply_fit_register_date_receive as date_receive,name as supply_fit_name,sample_approved,fit_comment');
