...
//                                                            echo date('d/m/Y', strtotime($all_informations[$i][1][$w]->date_receive));
                                             ...
                                             echo ",";
                                             if($all_informations[$i][0]->last_modified=='0000-00-00 00:00:00' || $all_informations[$i][0]->last_modified=='11/30/-0001'){echo '';}else{echo $all_informations[$i][0]->last_modified;}
                                             echo ",";
                                             if($all_informations[$i][0]->last_modified_qc=='0000-00-00 00:00:00' || $all_informations[$i][0]->last_modified_qc=='11/30/-0001'){echo '';}else{echo $all_informations[$i][0]->last_modified_qc;}
                                             echo "\n";
