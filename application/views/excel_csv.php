...
$header_array = array("Style No", "Season", "Department", "Style Description", "Supplier Name", "Dev Send Date", "Dev Receive Date", "Dev Pass/Fail By", "First Fit Send Date", "First Fit Receive Date", "First Fit Comment", "Second Fit Send Date", "Second Fit Receive Date", "Second Fit Comment", "Third Fit Send Date", "Third Fit Receive Date", "Third Fit Comment", "Fourth Fit Send Date", "Fourth Fit Receive Date", "Fourth Fit Comment", "Fifth Fit Send Date", "Fifth Fit Receive Date", "Fifth Fit Comment", "Fit Sample Pass/Fail", "Fit Sample Pass/Fail By", "PP Send Date", "PP Receive Date", "PP Pass/Fail By", "Wearer Send Date", "Wearer Receive Date", "Wearer Pass/Fail By", "Gold Sl Send Date", "Gold Sl Receive Date", "Gold Sl Pass/Fail BY", "Lab Test Report", "Pattern Block", "File Hand Over Date", "File Receive Date", "PP Meeting Date", "Wash Approval Date", "Wash Comment", "Inline Date", "Final Inspection Date", "Orders Comment", "Technician", "Remark", "Files", "Data Entry Date of Technician", "Data Entry Date of QC", "Last Modified by Technician", "Last Modified by QC");
